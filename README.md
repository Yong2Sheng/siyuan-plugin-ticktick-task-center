...
- 显示全部、活跃、已结束和今日推进任务统计，并按任务属性中的 `updated-at` 降序稳定排列。
- 在活跃任务中按“🌤️ 今日待推进”和“✨ 今日已推进”分组；待开始、进行中、等待回复和已阻塞任务都参与每日推进。
...
- “活跃任务”内部自动划分为“🌤️ 今日待推进”和“✨ 今日已推进”两个区域。
- 所有非终态任务都参与每日推进，包括待开始、进行中、等待回复和已阻塞；检查阻塞原因是否解除也可以视为一次推进。
- 点击 `🚀 今日推进` 后，任务移动到“今日已推进”，顶部今日进度同步增加。
